<x-splade-toggle>
    <nav class="fixed w-full bg-white border-b border-gray-100 shadow-2xl">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 transition duration-150 ease-in-out bg-white hover:text-gray-700 focus:outline-none">
                ...
                <div class="flex items-center -mr-2 sm:hidden">
                    <button @click="toggle" class="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500">
