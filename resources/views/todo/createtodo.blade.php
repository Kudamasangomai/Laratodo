<x-app-layout>
    ...
    <div class="flex flex-row flex-wrap">
        <div class="flex-shrink w-full max-w-full px-3 md:px-4">
            <div class="flex flex-row items-center justify-between">
                <p class="my-3 text-lg font-bold">Create Todo</p>
    ...
    <x-splade-form action="{{ route('todos.store') }}" method="POST">
    ...
    <div class="w-full h-full px-8 py-6 bg-white rounded-lg shadow-lg columns-2">
          ...
          <div class="w-full p-6 bg-white ">
            ...
            <div class="w-full p-6 bg-white">
                ...
                <x-splade-input min="{{ date('Y-m-d') }}" name="StartDate" :label="__('StartDate')" date/>
